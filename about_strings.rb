...
It was the worst of times.
  ...
  def test_plus_will_concatenate_two_strings
    string = 'Hello, ' + 'World' # rubocop: disable Style/StringConcatenation
  ...
  in_ruby_version('1.8') do
    def test_in_older_ruby_single_characters_are_represented_by_integers
      ...
      assert_equal true, (?a + 1) == ?b # rubocop: disable Style/StringConcatenation
    end
  end
  ...
  def test_strings_are_unique_objects
    ...
    assert_equal true, a == b
    assert_equal false, a.object_id == b.object_id # rubocop: disable Lint/IdentityComparison
