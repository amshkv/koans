...
class AboutScope < Neo::Koan
  ...
  def test_nested_string_is_not_the_same_as_the_system_string
    assert_equal __, 'HI'.instance_of?(String)
  end
  ...
  def test_class_names_are_just_constants
    ...
    assert_equal __, 'HI'.instance_of?(MyString)
  end

  def test_constants_can_be_looked_up_explicitly
    assert_equal __, AboutScope.const_get(:PI) == PI
    assert_equal __, AboutScope.const_get(:MyString) == MyString
  end
